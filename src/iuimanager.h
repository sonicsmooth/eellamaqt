...
enum class UIType {LIBTREEVIEW, LIBTABLEVIEW, LIBSYMBOLEDITORVIEW};
enum class ViewType {CDW, MDI}; // closing dock widget or mdi
...
public:
    ...
    virtual void openUI(std::any, ViewType) = 0;
